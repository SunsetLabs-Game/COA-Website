      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[#00ffff]">Choose Your Path</h2>
            <p className="text-gray-300 text-lg mb-8">
              The future of Arcanis will be shaped by the faction that emerges victorious from the coming conflicts. Will
              you join the digital revolution of the Neon Syndicate, embrace the physical power of the Chrome Collective,
              or master the art of manipulation with the Shadow Protocol?
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-[#00aaff] hover:bg-[#00aaff]/80 text-white font-bold py-6 px-10 text-lg rounded-md border border-[#00aaff]/30 shadow-[0_0_15px_rgba(0,170,255,0.5)] transition-all duration-300 hover:shadow-[0_0_25px_rgba(0,170,255,0.8)] group">
                <span className="group-hover:animate-pulse">Join a Faction</span>
              </Button>
              <Link href="/gameplay">
                <Button
                  variant="outline"
